...
public class Stab extends Enchantment implements Listener {

    EnchantConfig config = HyTrident.getInstance().getEnchantConfig();
    String name;

    public Stab(String namespace) {
    ...
    public void onHit(ProjectileHitEvent e){
        ...
        double damage = (level/2) + trident.getDamage();

        trident.setDamage(damage + trident.getDamage());
